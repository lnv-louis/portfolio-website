...
} from "@/components/document-viewer-sidebar"
...
function PDFViewerLoadingSkeleton({
  ...
  return (
    <div {...stylex.props(pvStyles.loadingOverlay)}>
      {sidebarOpen ? (
        <DocumentViewerSidebarSkeleton inline={sidebarInline} />
      ) : null}
      <div {...stylex.props(pvStyles.loadingContent)}>
        <Spinner />
      </div>
    </div>
  )
...
function PDFViewerFallbackShell({
  ...
  const rootSx = stylex.props(pvStyles.root)

  return (
    <div
      data-slot="pdf-viewer"
      {...rootSx}
      className={cn(rootSx.className, className)}
    >
      {showToolbar ? (
        <PDFViewerToolbar
          activePage={1}
      ...
      <div {...stylex.props(pvStyles.viewerArea)}>
        {state === "loading" ? (
          <PDFViewerLoadingSkeleton sidebarInline sidebarOpen={sidebarOpen} />
        ) : null}
        {state === "error" ? (
          <div {...stylex.props(pvStyles.stateOverlay)}>
            {errorMessage}
          </div>
        ) : null}
        {state === "empty" ? (
          <div {...stylex.props(pvStyles.stateOverlay, pvStyles.stateOverlayCenter)}>
            <div {...stylex.props(pvStyles.stateContent)}>
              <div {...stylex.props(pvStyles.stateTitle)}>
  ...
  return (
    <Tooltip>
      <TooltipTrigger asChild>
        <span {...stylex.props(pvStyles.inlineFlex)}>{children}</span>
      </TooltipTrigger>
  ...
  return (
    <>
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end" {...stylex.props(pvStyles.dropdownMenuWidth)}>
          {showDownload ? (
...
function PDFViewerPageNumberControl({
  ...
  return (
    <div {...stylex.props(pvStyles.pageNumber)}>
      <span>Page</span>
      {isEditing ? (
        <Input
          ref={inputRef}
          ...
          pattern="[0-9]*"
          value={draftPage}
          {...stylex.props(pvStyles.pageNumberInput, pvStyles.pageNumberInputCenter)}
        ...
        <Button
          ...
          variant="ghost"
          size="sm"
          {...stylex.props(pvStyles.fontNormal)}
...
function PDFViewerSearchControl({
  ...
  return (
    <Popover>
      ...
      <PopoverContent align="end" {...stylex.props(pvStyles.searchContent)}>
        <div {...stylex.props(pvStyles.searchBody)}>
          <Input
          ...
          />
          <div {...stylex.props(pvStyles.searchResultRow)}>
            <div {...stylex.props(pvStyles.searchResultText)}>
              <div {...stylex.props(pvStyles.searchResultTruncate)}>
                {state.total ? (
                  <>
                    <span {...stylex.props(pvStyles.textPrimary)}>
            ...
            <div {...stylex.props(pvStyles.searchNavButtons)}>
              <Button
                type="button"
                variant="outline"
                size="icon-sm"
          ...
          <div {...stylex.props(pvStyles.searchClearRow)}>
            <Button
              type="button"
              variant="outline"
              size="sm"
...
function PDFViewerToolbar({
  ...
  return (
    <div {...stylex.props(pvStyles.toolbar)}>
      <div {...stylex.props(pvStyles.toolbarLeft)}>
        <TooltipProvider>
      ...
      <TooltipProvider>
        <div {...stylex.props(pvStyles.toolbarRight)}>
          {showRotateControls ? (
            <>
              <div {...stylex.props(pvStyles.toolbarGroup)}>
                ...
                <ToolbarTooltip label="Rotate clockwise">
                  ...
                  >
                    <HugeiconsIcon
                      icon={RotateClockwiseIcon}
                      size={16}
                      {...stylex.props(pvStyles.iconFlipX)}
                    />
                  </Button>
                </ToolbarTooltip>
              </div>
              <Separator
                ...
                {...stylex.props(pvStyles.toolbarSep)}
              />
            </>
          ) : null}
          <div {...stylex.props(pvStyles.toolbarGroup)}>
            <ToolbarTooltip label="Zoom out">
              ...
              >
                <HugeiconsIcon icon={MinusSignCircleIcon} size={16} />
              </Button>
            </ToolbarTooltip>
            <Select
              ...
              modal={false}
            >
              <SelectTrigger size="sm" {...stylex.props(pvStyles.zoomTrigger)}>
          ...
          <Separator orientation="vertical" {...stylex.props(pvStyles.toolbarSep)} />
          {searchControl}
          {toolbarActions ? (
            <>
              <Separator
...
function PDFViewerScrollArea({
  ...
  const scrollSx = stylex.props(pvStyles.scrollAreaContainer)
  const innerSx = stylex.props(pvStyles.scrollAreaInner)
  ...
  return (
    <div
      ...
      {...scrollSx}
      className={cn(scrollSx.className, className)}
    >
      <ScrollArea {...scrollSx}>
        <div
          ...
          {...innerSx}
          className={cn(innerSx.className, viewportPropsClassName, viewportClassName)}
        >
          {children}
        </div>
      </ScrollArea>
      ...
      {(meta: ThumbMeta) => {
        ...
        return (
          <div
            ...
            {...stylex.props(
              pvStyles.thumbItem,
              isActive && pvStyles.thumbItemActive
            )}
          ...
          >
            <div
              ...
              {...stylex.props(
                pvStyles.thumbOption,
                pvStyles.thumbOptionHover,
                (isActive || isSelected) && pvStyles.thumbOptionActive,
              )}
              onClick={(event) => {
            ...
            >
              <span
                {...stylex.props(pvStyles.thumbImageWrap)}
                style={{
              ...
              >
                <ThumbImg
                  documentId={documentId}
                  meta={meta}
                  {...stylex.props(pvStyles.thumbImage)}
                  style={thumbnailImageStyle}
                />
              </span>
              <span
                {...stylex.props(pvStyles.thumbLabel)}
                style={{ height: meta.labelHeight }}
              >
                <span {...stylex.props(pvStyles.thumbLabelText)}>
                  {pageNumber}
                </span>
              </span>
            </div>
...
function PDFViewerThumbnailScrollArea({
  ...
  const thumbnailViewportSx = stylex.props(pvStyles.thumbnailViewport)

  return (
    <PDFViewerScrollArea
      viewportClassName={thumbnailViewportSx.className}
      viewportProps={{
    ...
    >
      <div
        {...stylex.props(pvStyles.thumbListRelative)}
...
function PDFViewerScrollAreaViewport({
  ...
  const viewportContentSx = stylex.props(pvStyles.viewportContent)

  return (
    <ViewportElementContext.Provider value={viewportRef}>
      <PDFViewerScrollArea
        className={className}
        viewportClassName={viewportContentSx.className}
        viewportProps={{
          style: {
            padding: viewportGap,
          },
    ...
    <>
      {rects.map((rect, index) => (
        <div
          ...
          {...stylex.props(pvStyles.pageSelectionLayer)}
          style={{
...
function PDFViewerInner({
  ...
  const renderPage = React.useCallback(
    (page: PageLayout) => {
      ...
      const pageContainerSx = stylex.props(pvStyles.pageContainer)
      ...
      return (
        ...
        >
          <PagePointerProvider
            ...
            {...pageContainerSx}
            className={cn(pageContainerSx.className, pageClassName?.(pageNumber))}
          ...
          >
            ...
            <RenderLayer
              ...
              {...stylex.props(pvStyles.pageRenderLayer)}
            />
            <TilingLayer
              documentId={documentId}
              pageIndex={page.pageIndex}
              key={`tiles-${page.pageIndex}-${pageRotation}`}
              {...stylex.props(pvStyles.pageTilingLayer)}
            />
            <SearchLayer
              documentId={documentId}
              pageIndex={page.pageIndex}
              {...stylex.props(pvStyles.pageSearchLayer)}
  ...
  return (
    ...
    >
      ...
      <div
        ref={viewerShellRef}
        {...stylex.props(pvStyles.viewerArea)}
      >
        {isLoading ? (
        ...
        <div {...stylex.props(pvStyles.viewerContent)}>
          <DocumentViewerThumbnailSidebar
          ...
          <PDFViewerScrollAreaViewport
            documentId={documentId}
            {...stylex.props(pvStyles.viewportContainer)}
          >
